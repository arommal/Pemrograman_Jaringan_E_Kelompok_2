...
class ReverseProxy:
    def __init__(self):
        self.url_dict = {}
        self.url_dict['/images/'] = ("127.0.0.1", 8889)
        self.url_dict['/pdf/'] = ("127.0.0.1", 9000)
        self.default_server = ("127.0.0.1", 8888)
...
if __name__ == "__main__":
    ...
    d = reverse_proxy.proses('GET /images/pokijan.jpg HTTP/1.0')
    print(d)
